...
usually webm/opus, sometimes mp4. whisper-server converts what it is given, so
the format is passed through rather than guessed at here.
"""
...
class WhisperCppSpeechToText:
    ...
    def transcribe(self, audio: AudioInput) -> Transcript:
        ...
        body, content_type = _multipart(
            "file", self.filename, audio.data, {"response_format": "json"}
        )
