...
- Milestone 4: Human Reference 선정 기준 완료, 외장 storage 계약 구현 중
...
| 3 | [외장 저장소와 manifest](https://github.com/WK-Hanelso/winter-ai/issues/71) | 재현 가능한 storage contract | Git 유입 방지 검증 |
